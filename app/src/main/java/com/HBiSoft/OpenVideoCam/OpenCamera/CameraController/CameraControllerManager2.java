package com.HBiSoft.OpenVideoCam.OpenCamera.CameraController;
...
public class CameraControllerManager2 extends CameraControllerManager {
	...
	public int getNumberOfCameras() {
		...
		try {
			...
			// in theory we should only get CameraAccessExceisHardwareLevelSupportedption, but Google Play shows we can get a variety of exceptions
